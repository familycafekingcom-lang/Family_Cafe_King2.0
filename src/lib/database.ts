...
export const DEFAULT_UPCOMING: LaunchRecord[] = [
  {
    id: "default-paan-king-grand-opening",
    created_at: "2026-07-01T00:00:00.000Z",
    city: "Grand Opening",
    brand: "Paan King",
    date_text: "20 July 2026 · Royal Paan Experience",
    image_data: "/images/upcoming-paan-king-grand-opening.jpg",
    tag: "Grand Opening",
    accent: "#1F7A3A",
  },
  {
    id: "default-morbi-gujarat",
    created_at: "2026-07-02T00:00:00.000Z",
    city: "Morbi, Gujarat",
    brand: "Paan King + Lassi King",
    date_text: "Coming Soon · Royal Taste & Tradition",
    image_data: "/images/upcoming-morbi-gujarat.jpg",
    tag: "Coming Soon",
    accent: "#1F7A3A",
  },
  {
    id: "default-barnala-punjab",
    created_at: "2026-07-03T00:00:00.000Z",
    city: "Barnala, Punjab",
    brand: "Paan King",
    date_text: "Opening Soon · Taste Real Flavour",
    image_data: "/images/upcoming-barnala-punjab.jpg",
    tag: "Opening Soon",
    accent: "#8C1F28",
  },
  {
    id: "default-kishangarh-rajasthan",
    created_at: "2026-07-04T00:00:00.000Z",
    city: "Kishangarh, Rajasthan",
    brand: "Chai Cafe King",
    date_text: "Opening Soon · A Royal Taste is Arriving",
    image_data: "/images/upcoming-kishangarh-rajasthan.jpg",
    tag: "Opening Soon",
    accent: "#E9A23B",
  },
];
